...
const DEFAULT_BOOKINGS: BannerBooking[] = [
  {
    ...
    phone: "9876543210", address: "East Masi St, Madurai", rating: 4.8,
  ...
  },
  {
    ...
    phone: "9876501234", address: "Bypass Road, Madurai", rating: 4.6,
    active: true, startDate: "2025-03-01", endDate: "2025-04-01",
  ...
  },
  {
    ...
    phone: "9876509876", address: "Goripalayam, Madurai", rating: 4.3,
    active: true, startDate: "2025-03-01", endDate: "2025-04-01",
