...
export const mockSearchProducts: Product[] = [
  ...
  // ── Fallback demo set: shared 6GB/128GB specs to trigger same-brand & cross-brand matches ──
  {
    id: 15,
  ...
  {
    id: 16,
    slug: "samsung-galaxy-m34-5g-variant",
    name: "Samsung Galaxy M34 5G Variant",
    category: "Smartphones",
    brand: "Samsung",
    image: "https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=400&h=400&fit=crop",
    description: "Samsung Galaxy M34 5G alternate variant with same core specs, refreshed colorway, online-only release.",
    specs: [["RAM", "6GB"], ["Storage", "128GB"], ["Battery", "6000mAh"]],
    localAvailable: false,
    prices: [
